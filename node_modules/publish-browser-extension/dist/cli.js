...
var FirefoxAddonStoreOptions = z3.object({
  ...
  extensionId: z3.string().min(1).trim(),
  jwtIssuer: z3.string().min(1).trim(),
  jwtSecret: z3.string().min(1).trim(),
...
async function prompt(message, options, previousValue) {
  let result = await consola2.prompt(message, {
